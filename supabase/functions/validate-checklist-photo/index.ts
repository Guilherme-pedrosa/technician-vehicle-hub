...
const CATEGORY_CRITERIA: Record<string, { label: string; criterio: string; has_critical: boolean; has_cleanliness_check?: boolean }> = {
  ...
  calibracao_de: {
    ...
    criterio: "Deve mostrar EVIDÊNCIA de calibragem em andamento. ACEITE quando a foto mostrar o BICO/MANGUEIRA encostado/conectado na VÁLVULA do pneu E TAMBÉM aparecer (em qualquer parte da foto, mesmo distante, em cima do carro, no chão, ao lado, parcial ou de longe) algum CALIBRADOR/MANÔMETRO/RELÓGIO/APARELHO DE AR (o popular &quot;reloginho&quot; analógico com mostrador redondo, display digital, pistola de inflar, corpo do inflador de posto/oficina). NÃO é necessário que a mangueira apareça inteira ligando os dois — basta ver o bico no pneu E o aparelho na mesma foto. NÃO exija leitura de pressão, NÃO exija enquadramento perfeito, NÃO exija ver o pneu inteiro. REJEITE somente se não houver bico/mangueira no pneu OU se NÃO aparecer nenhum tipo de calibrador/manômetro/reloginho na foto, ou se a foto mostrar só o pneu/roda sem qualquer evidência de calibração.",
    has_critical: true,
  },
  calibracao_dd: {
